...
while 1
	...
	Local $search = _ImageSearch('h3newgamebutton.png', 1, $x, $y, 15, $hbmp)
	If $search = 1 Then
		MouseClick("left", $x, $y)
	EndIf
	...
	If $search = 1 Then
		MouseClick("left", $x, $y)
	EndIf
	$search = _ImageSearch('h3joinbutton.png', 1, $x, $y, 15, $hbmp)
	If $search = 1 Then
		MouseClick("left", $x, $y)
	EndIf
	$search = _ImageSearch('h3hostipedit.png', 1, $x, $y, 15, $hbmp)
	If $search = 1 Then
		MouseClick("left", $x, $y)
		For $i = 0 To 50 Step 1
			Send("{BS}");
